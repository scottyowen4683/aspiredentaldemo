      ...
      <section id="how" className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Step
              icon={<Phone />}
              title="1) Answers instantly"
              text="AI picks up every call or chat in your tone and brand—24/7."
            />
            <Step
              icon={<HelpCircle />}
              title="2) Understands intent"
              text="Books, changes, FAQs, or emergencies—triaged in seconds."
            />
            <Step
              icon={<Calendar />}
              title="3) Books or sends link"
              text="Confirms a time or texts your HotDoc link for live availability."
            />
            <Step
              icon={<MessageSquare />}
              title="4) Confirms & notifies"
              text="SMS confirmation to the patient; concise summary to your team."
            />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 max-w-6xl grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-slate-700">
              ...
              It can answer whitening fees, insurance questions, emergencies, and send a HotDoc link
              so patients choose the exact time that suits.
            </p>
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-blue-100">
              We’ll configure your receptionist, SMS flows, and booking links — then go live in days.
            </p>
          </div>
...
const Package = ({ name, price, features, highlighted }) => (
  <div
    className={
      "rounded-2xl p-6 " +
      (highlighted ? "border border-blue-300 bg-blue-50" : "border border-slate-200 bg-white")
    }
  >
