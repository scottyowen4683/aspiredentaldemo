...
-- user_invites - proper scoped policies
ALTER TABLE IF EXISTS user_invites ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "service_role_full_access" ON user_invites;
DROP POLICY IF EXISTS "super_admin_all_access" ON user_invites;
DROP POLICY IF EXISTS "org_admin_manage_own" ON user_invites;
...
-- system_settings - only super admins should manage
...
DROP POLICY IF EXISTS "super_admin_all_access" ON system_settings;
...
-- scores table - proper scoped policies
ALTER TABLE IF EXISTS scores ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "service_role_full_access" ON scores;
DROP POLICY IF EXISTS "super_admin_all_access" ON scores;
DROP POLICY IF EXISTS "org_admin_view_own" ON scores;
...
-- Scores linked to conversations, scope by org
...
-- review_queue - proper scoped policies
ALTER TABLE IF EXISTS review_queue ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "service_role_full_access" ON review_queue;
DROP POLICY IF EXISTS "super_admin_all_access" ON review_queue;
DROP POLICY IF EXISTS "org_admin_manage_own" ON review_queue;
...
-- invites table - proper scoped policies
ALTER TABLE IF EXISTS invites ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "service_role_full_access" ON invites;
DROP POLICY IF EXISTS "super_admin_all_access" ON invites;
DROP POLICY IF EXISTS "org_admin_manage_own" ON invites;
...
-- settings_history - proper scoped policies
ALTER TABLE IF EXISTS settings_history ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "service_role_full_access" ON settings_history;
DROP POLICY IF EXISTS "super_admin_all_access" ON settings_history;
DROP POLICY IF EXISTS "org_admin_view_own" ON settings_history;
